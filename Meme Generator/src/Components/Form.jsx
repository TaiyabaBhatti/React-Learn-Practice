...
<div className='flex flex-col gap-y-1'>
    ...
    <input id='top-text' name="topText" value={props.topText}  type="text"  placeholder='Shut up' className='outline-none text-gray-500 w-56 rounded border-[0.82px] px-2 py-1 bg-white'  onChange={handler}/>
</div>

<div className='flex flex-col gap-y-1'>
    <label htmlFor="bottom-text" className='font-medium text-sm text-gray-700'>Bottom text</label>
    <input id='bottom-text' name="bottomText" value={bottomText} type="text"  placeholder='And take my money' onChange={handler} className='outline-none text-gray-500 w-56 rounded border-[0.82px] px-2 py-1 bg-white'/>
</div>
