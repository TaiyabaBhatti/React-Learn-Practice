...
<section className='bg-[url(./assets/images/about-bg.png)]  bg-no-repeat bg-cover bg-center h-80'>
...
<div className='bg-dull-orange p-5 space-y-4 rounded-l-lg'>
  ...
  <h1 className='font-bold text-2xl'>Your destination is waiting. <br /> Your van is ready.</h1>
